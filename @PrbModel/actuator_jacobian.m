function [J_su, g_su, J_u, B_b, B, P] = actuator_jacobian(obj, q)
%
...
%
% Output:
% J is a 3-d array of body Jacobians of the actuators. The Jacobians are
%  stacked along the 3rd dimension of the array.
% g is a 3-d array of actuator configurations. The configurations are
%  stacked along the 3rd dimension of the array.
