...
delta = (alpha_range(2) - alpha_range(1)) / 10;
alpha = [alpha_range(1):delta:alpha_range(2)]';
w_v_alpha = w_v(alpha);
...
figure(3) % draw P_s w.r.t the angles, given the blood smaple from velocity data
